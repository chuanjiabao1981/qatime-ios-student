...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        .leftEqualToView(self)
        .rightEqualToView(self)
        .topSpaceToView(_bar,0)
        .heightIs(0.4);
        
        /* logo图片布局*/
        _logoImage = [[UIImageView alloc]init];
        [_bar addSubview:_logoImage];
        [_logoImage setImage:[UIImage imageNamed:@"Logo"]];
        
        _logoImage.sd_layout
        .topSpaceToView(_bar,10)
        .bottomSpaceToView(_bar,10)
        .centerXEqualToView(_bar)
...
//        _text2.layer.cornerRadius = M_PI;
        ...
        .topSpaceToView(_bar,40)
        .rightSpaceToView(self,20)
        .heightRatioToView(_bar,1.2f);
