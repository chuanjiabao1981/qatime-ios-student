...
- (void)viewDidLoad {
    ...
    _menuTableView = ({
        UITableView *_=[[UITableView alloc]initWithFrame:CGRectMake(0, Navigation_Height, CGRectGetWidth(self.view.frame), CGRectGetHeight(self.view.frame)-Navigation_Height)];
        [self.view addSubview:_];
        _.delegate = self;
        _.dataSource =self;
