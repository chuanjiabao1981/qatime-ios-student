...
#define NTESWhiteboardCmdFormatPoint @"%zd:%.4f,%.4f,%d;"
...
{
    return [NSString stringWithFormat:NTESWhiteboardCmdFormatPoint, point.type, point.xScale, point.yScale, point.colorRGB];
}
