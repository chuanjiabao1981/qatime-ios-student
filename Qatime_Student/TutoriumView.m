...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _timeButton.sd_layout.leftSpaceToView(_buttonContentView,10).topSpaceToView(_buttonContentView,10).bottomSpaceToView(_buttonContentView,10).widthRatioToView(_buttonContentView,0.2f);
        ...
        _subjectButton.sd_layout.leftSpaceToView(_timeButton,CGRectGetWidth(self.bounds)/10.0f).topSpaceToView(_buttonContentView,10).bottomSpaceToView(_buttonContentView,10).widthRatioToView(_buttonContentView,0.2f);
        ...
        _gradeButton.sd_layout.leftSpaceToView(_subjectButton,CGRectGetWidth(self.bounds)/10.0f).topSpaceToView(_buttonContentView,10).bottomSpaceToView(_buttonContentView,10).widthRatioToView(_buttonContentView,0.2f);
        ...
        _filtersButton.sd_layout.rightSpaceToView(_buttonContentView,10).topSpaceToView(_buttonContentView,10).bottomSpaceToView(_buttonContentView,10).widthRatioToView(_buttonContentView,0.06f);
