...
//        [_classImage setImage:[UIImage imageNamed:@"school"]];
        ...
        _teacherName.sd_layout.leftSpaceToView(self.contentView,0).topSpaceToView(_classImage,5).autoHeightRatio(0);
        ...
        _price.sd_layout.leftSpaceToView(self.contentView,0).topSpaceToView(_teacherName,5).autoHeightRatio(0);
