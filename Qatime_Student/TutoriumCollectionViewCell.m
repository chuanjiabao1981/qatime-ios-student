...
//        _grade.textAlignment = NSTextAlignmentRight;
        ...
        _price.sd_layout.leftSpaceToView(self.contentView,0).topSpaceToView(_className,5).autoHeightRatio(0);
        [_price setSingleLineAutoResizeWithMaxWidth:80];
        ...
        _teacherName.sd_layout.rightSpaceToView(self.contentView,0).bottomEqualToView(_price).topEqualToView(_price).autoHeightRatio(0);
        [_teacherName setSingleLineAutoResizeWithMaxWidth:80];
