...
public class JTSliderView : UIView {
...
public enum JTItemViewState : Int {
    case Normal
    case Selected
}

public class JTItemView : UIView {
    ...
    public lazy var bridgeView : CALayer = {
        let view = CALayer()
    ...
    public func showBridge(show:Bool){
        self.bridgeView.isHidden = !show
    }
    
    public var state : JTItemViewState = .Normal {
        didSet{
    ...
    public override func layoutSubviews() {
        ...
        bridgeView.frame = CGRect(x: x+5, y: bounds.midY - width, width: width, height: width)
    }
...
open class JTSegmentControl: UIControl {
    ...
    open var sliderViewHeight = JTSegmentPattern.sliderHeight{
       
        didSet{
            
            self.sliderView.frame.size.height = sliderViewHeight
    ...
    public lazy var sliderView : JTSliderView = JTSliderView()
    public var itemViews = [JTItemView]()
    ...
    public func currentItemX(index:Int) -> CGFloat {
        if autoAdjustWidth {
            var x:CGFloat = 0.0
            for i in 0..<index {
    ...
    public func centerX(with index:Int) -> CGFloat {
        if autoAdjustWidth {
    ...
    open override func layoutSubviews() {
        ...
        sliderView.frame = CGRect(x: currentItemX(index: selectedIndex), y: contentView.bounds.size.height - JTSegmentPattern.sliderHeight, width: width, height: 2)
